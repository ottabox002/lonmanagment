...
// function getdetails(pincode , row)
//  {
...
//  {
//     var pincode = $(".pincode-input1").val();
//         var token = "{{ csrf_token() }}";
//     $.ajax({
//         url: "{{ url('getpincodedetails') }}/" ,
//         type: 'post',
...
//                         $('#per_state_code').val(stateCode);
//                         $('#per_country_code').val(countryCode);
//                     }
//                 });
//         }
//     });
...
function getperaddress()
{
    var val = $("input[name='different_address[]']:checked").val();

    if(val == 'Yes')
    {
        //disable all fields
        $("#permanent_address").prop('readonly', true);
        $("#per_pincode").prop('readonly', true);
        $("#per_city").attr("style", "pointer-events: none;");
        ...
        // get value all pronciplt address feild
        $address = $("#principal_address").val();
        $pincode = $("#pincode").val();
        $city = $("#city").val();
        ...
        //implemnet data into perment office address
        $("#permanent_address").val($address);
        $("#per_pincode").val($pincode);
        // $("#per_city").val($city);
        $("#per_District").val($district);
        $("#per_State").val($state);
    ...
    else
    {
        ...
        $("#per_pincode").prop('readonly', false);
...
//         // get value all pronciplt address feild
//         $address = $(row).find(".principal-address").val();
//         $pincode = $(row).find(".pincode-input").val();
//         $city = $(row).find(".city").val();
//         $district = $(row).find(".district").val();
//         $state = $(row).find(".state").val();
//         $state_code = $(row).find(".state-code").val();
//         $country_code = $(row).find(".country-code").val();
...
//     alert(val);
//     die();
//     var row = $(input).closest('.form-group').parent(); // Find the parent div of the radio button group

//     if (val === 'Yes') {
//         // Disable all fields
//         row.find(".permanent_address").prop('readonly', true);
//         row.find(".pincode-input1").prop('readonly', true);
//         row.find(".per_city").attr("disabled", true);
//         row.find(".per_District").prop('readonly', true);
//         row.find(".per_State").prop('readonly', true);
//         row.find(".per_state_code").prop('readonly', true);
//         row.find(".per_country_code").prop('readonly', true);
...
//         }
//     } else {
//         // Enable all fields and clear values
//         row.find(".permanent_address").prop('readonly', false);
//         row.find(".pincode-input1").prop('readonly', false);
//         row.find(".per_city").prop('disabled', false);
//         row.find(".per_District").prop('readonly', false);
...
// function getperaddress(input) {
//     var val = $(input).val();
//     var row = $(input).closest('.col-lg-6').parent().parent(); // Find the parent row of the radio button group
...
function addPincodeEventListener(row) {
    ...
    pincodeInput.addEventListener('input', function() {
        checkPincodeLength(pincodeInput, row); // Pass both pincode input and its row
    });
}
