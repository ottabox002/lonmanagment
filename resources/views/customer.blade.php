                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="entity_type" name="entity_type[]">
                                                    ...
                                                    <option value="PROPRIETORSHIP[]"
                                                        {{ old('entity_type') == 'PROPRIETORSHIP' ? 'selected' : '' }}>
                                                        PROPRIETORSHIP</option>
                                                    <option value="Partnership[]"
                                                        {{ old('entity_type') == 'Partnership' ? 'selected' : '' }}>
                                                        Partnership</option>
                                                    <option value="Pvt_Ltd"
                                                        {{ old('entity_type') == 'Pvt_Ltd' ? 'selected' : '' }}>Pvt Ltd
                                                    </option>
                                                    <option value="Others[]"
                                                        {{ old('Others') == 'Others' ? 'selected' : '' }}>Others</option>
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" id="date_of_incorporation"
                                                    name="date_of_incorporation[]" value="">
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control state-code" id="state_code"
                                                    name="state_code[]" value="{{ old('state_code[]') }}">
                                                @error('state_code')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group d-flex align-items-center">
                                                ...
                                                <div class="form-check ml-2 mr-2">
                                                    <input type="checkbox" class="form-check-input daddress"
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control pincode-input1"
                                                    ...
                                                    name="per_pincode[]" value="{{ old('per_pincode[]') }}">
                                                @error('per_pincode')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control per_District" id="per_District"
                                                    name="per_District[]" value="{{ old('per_District[]') }}">
                                                @error('per_District')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control per_State" id="per_State"
                                                    name="per_State[]" value="{{ old('per_State[]') }}">
                                                @error('per_State')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="corporation_place"
                                                    name="corporation_place[]" value="{{ old('corporation_place[]') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="Segment" name="Segment[]">
                                                    ...
                                                    <option value="Trading"
                                                        {{ old('Segment') == 'Trading' ? 'selected' : '' }}>Trading
                                                    </option>
                                                    <option value="Manufacturing"
                                                        {{ old('Segment') == 'Manufacturing' ? 'selected' : '' }}>
                                                        Manufacturing</option>
                                                    <option value="Service_Provider"
                                                        {{ old('Segment') == 'Service_Provider' ? 'selected' : '' }}>
                                                        Service Provider</option>
                                                    <option value="Others"
                                                        {{ old('Segment') == 'Others' ? 'selected' : '' }}>Others</option>
                                                    <!-- Add more options as needed -->
                                                </select>
                                                @error('Segment')
                                                    <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="bussiness_vintage"
                                                    name="bussiness_vintage[]" value="{{ old('bussiness_vintage[]') }}">
